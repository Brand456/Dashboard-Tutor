...
df = pd.read_csv('src/Archivo_de_ingenieria_porcentajes.csv', encoding='latin1', delimiter='|')
df_calificaciones = pd.read_csv('src/Archivo_de_ingenieria.csv', encoding='latin1',delimiter='|')
df_totales = pd.read_csv('src/Archivo_de_ingenieria_totales.csv', encoding='latin1', delimiter='|')
df_pie = pd.read_csv('src/Archivo_de_ingenieria_datos.csv', encoding='latin1', delimiter='|')


#segundos datos
df_TE =pd.read_csv('src/Archivo_de_TIC_porcentajes.csv', encoding='latin1', delimiter='|')
df_calificaciones_TE = pd.read_csv('src/Archivo_de_TIC.csv', encoding='latin1', delimiter='|')
df_totales_TE = pd.read_csv('src/Archivo_de_TIC_totales.csv', encoding='latin1', delimiter='|')
df_pie_TE = pd.read_csv('src/Archivo_de_TIC_datos.csv', encoding='latin1', delimiter='|')
